...
<?php
  foreach ($result as $row){
    ...
    <a href="shows.php?show_id=<?php echo $row['show_id']; ?>"> </a>
      <div class="card" style="background-color: #3a3a3a; padding-top: 35px; padding-bottom: 35px; margin-bottom: 30px;">
          ...
          <div class="card-body">
            ...
            <p><a class="btn btn-warning " data-toggle="collapse" data-target="#viewdetails<?php echo $row['show_id']; ?>">Show Info</a> <a href="archive.php?show_id=<?php echo $row['show_id']; ?>" class="btn btn-warning">Archives</a> </p>
          </div>
      </div>
      </div>
    <?php
